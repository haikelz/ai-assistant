...
func Load() Config {
	return Config{
		...
		TelegramBotToken: strings.TrimSpace(os.Getenv("TELEGRAM_BOT_TOKEN")), TelegramUserID: strings.TrimSpace(os.Getenv("TELEGRAM_USER_ID")), SpreadsheetID: strings.TrimSpace(os.Getenv("GOOGLE_SHEETS_SPREADSHEET_ID")), ServiceAccountBase64: strings.TrimSpace(os.Getenv("GOOGLE_SERVICE_ACCOUNT_JSON_BASE64")),
	}
}
